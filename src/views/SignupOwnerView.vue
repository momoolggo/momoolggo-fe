    ...
    <div class="signup_card">
      ...
      <div class="field">
        ...
        <div class="input_wrap">
          ...
          <button class="pw_toggle" @click="state.showPw = !state.showPw"><i :class="state.showPw ? 'bi bi-eye' : 'bi bi-eye-slash'"></i></button>
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="input_wrap">
          ...
          <button class="pw_toggle" @click="state.showPwConfirm = !state.showPwConfirm"><i :class="state.showPwConfirm ? 'bi bi-eye' : 'bi bi-eye-slash'"></i></button>
        </div>
      </div>
